...
new_img=[]
dataset_read= gdal.Open("20141226AOD.tif")
...
img_write_data=y_img.reshape(74,72)#注意顺序，重新整理成图像的维度

img_write_dtype=gdal.GDT_Float64#待写入文件的类型
#创建文件
driver=gdal.GetDriverByName("GTiff")
dataset_write = driver.Create("MOD_PM_20141226_RF_all.tif",img_read_width,img_read_height,img_read_band,img_write_dtype)#只有最后的参数int->float
